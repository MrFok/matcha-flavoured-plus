...
| Smithing enchantments | Run `/function main:smithing_enchantments/test/give_regression_kit`, keep an existing matching material item elsewhere in the inventory, and craft the supplied upgrades. | The crafted output keeps compatible base enchantments and gains material minimums; the pre-existing matching item is unchanged. |

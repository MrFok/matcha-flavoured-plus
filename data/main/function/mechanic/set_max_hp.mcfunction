...
execute as @a[scores={Hearts=19}] run attribute @s minecraft:max_health base set 19
execute as @a[scores={Hearts=18}] run attribute @s minecraft:max_health base set 18
execute as @a[scores={Hearts=17}] run attribute @s minecraft:max_health base set 17
execute as @a[scores={Hearts=16}] run attribute @s minecraft:max_health base set 16
execute as @a[scores={Hearts=15}] run attribute @s minecraft:max_health base set 15
execute as @a[scores={Hearts=14}] run attribute @s minecraft:max_health base set 14
execute as @a[scores={Hearts=13}] run attribute @s minecraft:max_health base set 13
execute as @a[scores={Hearts=12}] run attribute @s minecraft:max_health base set 12
execute as @a[scores={Hearts=11}] run attribute @s minecraft:max_health base set 11

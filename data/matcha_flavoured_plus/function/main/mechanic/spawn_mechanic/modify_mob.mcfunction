...
execute as @s run data merge entity @n[type=#matcha_flavoured_plus:main/mundane_hostiles] {drop_chances:{feet:0.0f,legs:0.0f,chest:0.0f,head:0.0f,mainhand:0.0f}}

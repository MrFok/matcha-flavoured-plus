...
execute at @a run execute if score @p eerie >= 1 eerie run execute if predicate matcha_flavoured_plus:main/not_in_village run advancement revoke @p only matcha_flavoured_plus:main/mechanics/enter_village_plains
execute at @a run execute if score @p eerie >= 1 eerie run execute if predicate matcha_flavoured_plus:main/not_in_village run scoreboard players set @p eerie 0

# execute at @a run execute if score @p eerie >= 1 eerie run execute if stopwatch eerie 1..10 run execute if predicate matcha_flavoured_plus:main/in_village_on_oak_planks_inside run playsound minecraft:block.wood.step player @a ~-4 ~4 ~

...
# execute at @p run execute if entity @n[type=wither,distance=..10] run execute as @e[type=wither] at @s rotated as @p run function matcha_flavoured_plus:main/backend/apply_motion

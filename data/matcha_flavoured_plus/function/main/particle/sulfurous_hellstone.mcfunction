...
execute at @p if block ~ ~-.1 ~ minecraft:nether_quartz_ore run schedule function matcha_flavoured_plus:main/particle/sulfurous_hellstone 3t
...
advancement revoke @p only matcha_flavoured_plus:main/particle/on_sulfur